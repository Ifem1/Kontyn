...
const required = ["create_org", "configure_treasury_policy", "add_capability", "fund_org", "activate_org", "open_epoch", "finalize_challenge_window", "submit_counter_evidence", "resolve_challenge", "execute_ready_action", "withdraw_allocation", "recover_expired_allocation", "cancel_ready_action", "get_org", "get_charter", "get_capability", "get_epoch", "get_action", "get_treasury_state", "get_timing_state"];
